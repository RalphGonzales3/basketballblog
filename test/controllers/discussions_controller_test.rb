...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { basketball_id: @discussion.basketball_id, body: @discussion.body } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { basketball_id: @discussion.basketball_id, body: @discussion.body } }
